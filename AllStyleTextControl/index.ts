...
export class AllStyleTextControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
    {
        ...
        //this._input.classList.add(this._class);
		this._input.setAttribute("style", this._style);
        //this._input.style.cssText += this._style;
		this._value = context.parameters.AllStyleInputTextField.raw || "";
    ...
    {
        return {
            AllStyleInputTextField: this._value
          };
    }
